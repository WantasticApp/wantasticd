...
type PollDeviceFlowResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	Token         string                 `protobuf:"bytes,2,opt,name=token,proto3" json:"token,omitempty"` // Token needed for GetConfiguration
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// SetNodeRoutingRequest allows a tenant to configure routing preferences
type SetNodeRoutingRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	ExitNodeId    string                 `protobuf:"bytes,2,opt,name=exit_node_id,json=exitNodeId,proto3" json:"exit_node_id,omitempty"`           // Device ID or PubKey of the desired exit node
	EntryNodeId   string                 `protobuf:"bytes,3,opt,name=entry_node_id,json=entryNodeId,proto3" json:"entry_node_id,omitempty"`        // Device ID or PubKey of the desired entry node
	OfferExitNode bool                   `protobuf:"varint,4,opt,name=offer_exit_node,json=offerExitNode,proto3" json:"offer_exit_node,omitempty"` // Whether this device offers itself as an exit node
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SetNodeRoutingRequest) Reset() {
	*x = SetNodeRoutingRequest{}
	mi := &file_auth_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetNodeRoutingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetNodeRoutingRequest) ProtoMessage() {}

func (x *SetNodeRoutingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_auth_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetNodeRoutingRequest.ProtoReflect.Descriptor instead.
func (*SetNodeRoutingRequest) Descriptor() ([]byte, []int) {
	return file_auth_proto_rawDescGZIP(), []int{14}
}

func (x *SetNodeRoutingRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SetNodeRoutingRequest) GetExitNodeId() string {
	if x != nil {
		return x.ExitNodeId
	}
	return ""
...
func (x *SetNodeRoutingRequest) GetEntryNodeId() string {
	if x != nil {
...
func (x *SetNodeRoutingRequest) GetOfferExitNode() bool {
	if x != nil {
		return x.OfferExitNode
	}
	return false
}

// SetNodeRoutingResponse indicates the status of the routing assignment
type SetNodeRoutingResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
...
func (x *SetNodeRoutingResponse) Reset() {
	*x = SetNodeRoutingResponse{}
	mi := &file_auth_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetNodeRoutingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetNodeRoutingResponse) ProtoMessage() {}

func (x *SetNodeRoutingResponse) ProtoReflect() protoreflect.Message {
	mi := &file_auth_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetNodeRoutingResponse.ProtoReflect.Descriptor instead.
func (*SetNodeRoutingResponse) Descriptor() ([]byte, []int) {
	return file_auth_proto_rawDescGZIP(), []int{15}
}

func (x *SetNodeRoutingResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *SetNodeRoutingResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_auth_proto_rawDesc = "" +
	...
	"\x15SetNodeRoutingRequest\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12 \n" +
	"\fexit_node_id\x18\x02 \x01(\tR\n" +
	"exitNodeId\x12\"\n" +
	"\rentry_node_id\x18\x03 \x01(\tR\ventryNodeId\x12&\n" +
	"\x0foffer_exit_node\x18\x04 \x01(\bR\rofferExitNode\"L\n" +
	"\x16SetNodeRoutingResponse\x12\x18\n" +
	...
	"\x0ePollDeviceFlow\x12\x1b.grpc.PollDeviceFlowRequest\x1a\x1c.grpc.PollDeviceFlowResponse\x12K\n" +
	"\x0eSetNodeRouting\x12\x1b.grpc.SetNodeRoutingRequest\x1a\x1c.grpc.SetNodeRoutingResponseB\x1fZ\x1dwantastic-agent/internal/grpcb\x06proto3"
...
var file_auth_proto_goTypes = []any{
	...
	(*SetNodeRoutingRequest)(nil),    // 14: grpc.SetNodeRoutingRequest
	(*SetNodeRoutingResponse)(nil),   // 15: grpc.SetNodeRoutingResponse
}
var file_auth_proto_depIdxs = []int32{
	...
	14, // 9: grpc.AuthService.SetNodeRouting:input_type -> grpc.SetNodeRoutingRequest
	1,  // 10: grpc.AuthService.RegisterDevice:output_type -> grpc.RegisterDeviceResponse
	3,  // 11: grpc.AuthService.RefreshToken:output_type -> grpc.RefreshTokenResponse
	5,  // 12: grpc.AuthService.GetConfiguration:output_type -> grpc.GetConfigurationResponse
	11, // 13: grpc.AuthService.StartDeviceFlow:output_type -> grpc.StartDeviceFlowResponse
	13, // 14: grpc.AuthService.PollDeviceFlow:output_type -> grpc.PollDeviceFlowResponse
	15, // 15: grpc.AuthService.SetNodeRouting:output_type -> grpc.SetNodeRoutingResponse
