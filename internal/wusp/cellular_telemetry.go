...
var AllWUSPCellularTelemetryParams = []Param{
	...
	{Path: WUSPCellularTelemetryPrefix + "Interface.{i}.Manufacturer", Type: TypeString, Access: ReadOnly, SinceVersion: "1.0", Description: "Modem manufacturer reported by ModemManager or AT identity commands.", Limits: Limits{MaxLength: 128}},
	{Path: WUSPCellularTelemetryPrefix + "Interface.{i}.Model", Type: TypeString, Access: ReadOnly, SinceVersion: "1.0", Description: "Modem model reported by ModemManager or AT identity commands.", Limits: Limits{MaxLength: 128}},
	{Path: WUSPCellularTelemetryPrefix + "Interface.{i}.Revision", Type: TypeString, Access: ReadOnly, SinceVersion: "1.0", Description: "Modem firmware revision reported by ModemManager or AT identity commands.", Limits: Limits{MaxLength: 128}},
	{Path: WUSPCellularTelemetryPrefix + "Interface.{i}.EquipmentIdentifier", Type: TypeString, Access: ReadOnly, SinceVersion: "1.0", Description: "Equipment identifier for the cellular module, normally the IMEI.", Limits: Limits{MaxLength: 32}},
	{Path: WUSPCellularTelemetryPrefix + "Interface.{i}.SubscriberIdentity", Type: TypeString, Access: ReadOnly, SinceVersion: "1.0", Description: "Subscriber identity for the active SIM, normally IMSI.", Limits: Limits{MaxLength: 32}},
	{Path: WUSPCellularTelemetryPrefix + "Interface.{i}.SIMIdentifier", Type: TypeString, Access: ReadOnly, SinceVersion: "1.0", Description: "SIM card identifier, normally ICCID.", Limits: Limits{MaxLength: 32}},
	{Path: WUSPCellularTelemetryPrefix + "Interface.{i}.PhoneNumber", Type: TypeString, Access: ReadOnly, SinceVersion: "1.0", Description: "MSISDN phone number reported by the active SIM when available.", Limits: Limits{MaxLength: 32}},
	{Path: WUSPCellularTelemetryPrefix + "Interface.{i}.CollectedAt", Type: TypeDateTime, Access: ReadOnly, SinceVersion: "1.0", Description: "Time when this modem telemetry row was collected."},
	...
	{Path: WUSPCellularTelemetryPrefix + "Interface.{i}.TemperatureC", Type: TypeInt, Access: ReadOnly, SinceVersion: "1.0", Description: "Average modem temperature in Celsius from Quectel AT+QTEMP."},
	{Path: WUSPCellularTelemetryPrefix + "Interface.{i}.LTETimingAdvance", Type: TypeInt, Access: ReadOnly, SinceVersion: "1.0", Description: "LTE timing advance from Quectel AT+QNWCFG=\"lte_time_advance\".", Limits: Limits{Min: iptr(0)}},
	{Path: WUSPCellularTelemetryPrefix + "Interface.{i}.NR5GTimingAdvance", Type: TypeInt, Access: ReadOnly, SinceVersion: "1.0", Description: "NR5G timing advance from Quectel AT+QNWCFG=\"nr5g_time_advance\".", Limits: Limits{Min: iptr(0)}},
