...
func TestCellularPublishIncludesIdentityAndStats(t *testing.T) {
	...
	assertListContains(t, msg, "Device.Cellular.Interface.1.SIMReferenceList", "Device.TrustedElements.SIM.1.")
	assertStringField(t, msg, "Device.TrustedElements.SIM.1.Status", "Valid")
	assertStringField(t, msg, "Device.TrustedElements.SIM.1.Type", "USIM")
	assertStringField(t, msg, "Device.TrustedElements.SIM.1.Usage", "UICC")
	assertStringField(t, msg, "Device.TrustedElements.SIM.1.IMSI", "310410123456789")
	assertStringField(t, msg, "Device.TrustedElements.SIM.1.ICCID", "89014103211118510720")
